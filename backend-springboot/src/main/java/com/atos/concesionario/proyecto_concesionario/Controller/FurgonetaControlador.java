...
public class FurgonetaControlador {
    ...
    private final FurgonetaServicio furgonetaServicio;

    @Autowired
    public FurgonetaControlador(FurgonetaServicio furgonetaServicio) {
        this.furgonetaServicio = furgonetaServicio;
    }
